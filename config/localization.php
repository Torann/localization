...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Negotiate for the user locale using the Accept-Language header if it's
    | not defined in the URL. If false, system will take app.php
    | locale attribute
    |
    */
    ...
    |
    | These are sorted by the native name, which is the order you might show
    | them in a language selector. Regional languages are sorted by their base
    | language, so "British English" sorts as "English, British"
    |
    */
    ...
    'supported_locales' => [
        ...
        //],
        //'tzm' => [
        //    'name' => 'Central Atlas Tamazight (Tifinagh)','script' => 'Tfng',
        //    'native' => 'ⵜⴰⵎⴰⵣⵉⵖⵜ',
        //    'regional' => '',
        //],
        //'yue' => [
